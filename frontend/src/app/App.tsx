...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-[#111111] font-sans selection:bg-[#ff3b30] selection:text-white relative">
      {/* Global Top Floating Navbar */}
      <Navbar
        onOpenServicesDrawer={handleScrollToServices}
      />
